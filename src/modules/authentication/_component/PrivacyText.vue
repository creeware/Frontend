<template>
  <div>
    <p>
      At Creeware, accessible from creeware.com, one of our main priorities is
      the privacy of our visitors. This Privacy Policy document contains types
      of information that is collected and recorded by Creeware and how we use
      it.
    </p>
    ...
    <p>
      Team Powerline's legal basis for collecting and using the personal
    ...
    <ul>
      <li>Team Powerline needs to perform a contract with you</li>
      <li>You have given Team Powerline permission to do so</li>
      <li>
        Processing your personal information is in Team Powerline's legitimate
        interests
      </li>
      <li>Team Powerline needs to comply with the law</li>
    </ul>

    <p>
      Team Powerline will retain your personal information only for as long as
      is necessary for the purposes set out in this Privacy Policy. We will
      retain and use your information to the extent necessary to comply with our
      legal obligations, resolve disputes, and enforce our policies. Our Privacy
      Policy was generated with the help of
      <a
        href="https://gdprprivacynotice.com/"
      >GDPR Privacy Policy Generator</a>, the
      <a href="https://privacy-policy-template.com/">GDPR Privacy Policy Template</a>
      and the
      <a
        href="https://termsfeed.com/privacy-policy/generator/"
      >Privacy Policy Generator from TermsFeed</a>.
    </p>
    ...
    <p>
      Creeware follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, Creeware uses 'cookies'. These cookies are used to
    ...
    <P>
      ...
      advertising partners of Creeware.
    </P>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Creeware, which are sent directly
    ...
    <p>
      Note that Creeware has no access to or control over these cookies that are
    ...
    <p>
      Creeware's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      Creeware does not knowingly collect any Personal Identifiable Information
    ...
    <p>
      ...
      and/or collect in Creeware. This policy is not applicable to any
